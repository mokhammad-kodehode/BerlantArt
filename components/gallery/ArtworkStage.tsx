  ...
  return (
    <section className="bg-wall relative flex min-h-svh flex-col overflow-hidden">
      ...
      */}
      ...
      {/*
        Соседний зал слева — сильно размытый снимок галерейного помещения
        (globals.css, .stage-room). Лежит под слоем .stage-hall, поэтому
        затенение в углу ложится и на него.

        Файл весит 0.5 КБ: размытие запечено в картинку шириной 220px,
        растягивает её браузер. Размывать полноразмерный снимок фильтром
        в браузере было бы и тяжелее, и медленнее.

        Только десктоп и только зал «почти белый» — см. globals.css.
      */}
