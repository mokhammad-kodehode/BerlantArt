...
/**
 * Сколько работ в галерее всего. Главная сравнивает это число с тем,
 * сколько показала сама, и не зовёт «смотреть всю галерею», когда
 * там не найдётся ничего нового.
 */
